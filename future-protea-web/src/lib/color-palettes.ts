 ...
 * ORANGE is first and DEFAULT to match existing Future Protea theme
 */
export const colorPalettes: ColorPalette[] = [
  // 1. Orange - Future Protea Brand (DEFAULT)
  {
    id: 'orange',
    name: 'Orange',
    emoji: '🧡',
    description: 'Future Protea Brand',
    category: 'warm',
    light: {
  ...
  // 2. Aurora - Magical northern lights
  {
    id: 'aurora',
    name: 'Aurora',
    emoji: '✨',
  ...
  // 6. Obsidian - Volcanic glass with gold
  {
    id: 'obsidian',
    name: 'Obsidian',
    emoji: '🖤',
  ...
  // 8. Dusk - Twilight between day and night
  {
    id: 'dusk',
    name: 'Dusk',
    emoji: '🌅',
  ...
  // 12. Sand - Desert dunes at golden hour
  {
    id: 'sand',
    name: 'Sand',
    emoji: '🏜️',
  ...
  // 13. Graphite - Minimal architect sketch
  {
    id: 'graphite',
    name: 'Graphite',
    emoji: '✏️',
...
/**
 * Default palette ID - Orange (Future Protea Brand)
 */
