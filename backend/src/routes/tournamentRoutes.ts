...
router.put('/tournaments/:id', authenticate, authorize(['admin']), tournamentController.updateTournament as any);
router.post('/tournaments/:id/logo', authenticate, authorize(['admin']), upload.single('logo'), tournamentController.uploadTournamentLogo as any);
